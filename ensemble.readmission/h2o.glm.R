...
rates_table = h2o.cbind(flightsByMonth$Month,airlines.split = h2o.splitFrame(data = airlines.hex,ratios = 0.85)
...
UniqueCarrier", "DayOfWeek", "Month", "DepTime", "ArrTime", "Distance")
